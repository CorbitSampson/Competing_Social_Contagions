...
#np.savetxt('max_change_0_P4.txt',change0max)
#np.savetxt('max_change_p_P4.txt',changepmax)
#np.savetxt('max_change_n_P4.txt',changenmax)
#np.savetxt('avg_change_0_P4.txt',change0avg)
#np.savetxt('avg_change_0_P4.txt',changepavg)
#np.savetxt('avg_change_0_P4.txt',changenavg)
