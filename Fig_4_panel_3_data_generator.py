...
betabar = 0.62069                                  # infection rate
...
titlestring = 'sim_stability_sweep_P3.txt'
np.savetxt(titlestring, sweepvar)
print('Simulation for panel 3 has ended')
print('Max change after 3000 time steps is:')
#np.savetxt('max_change_0_P3.txt',change0max)
#np.savetxt('max_change_p_P3.txt',changepmax)
#np.savetxt('max_change_n_P3.txt',changenmax)
#np.savetxt('avg_change_0_P3.txt',change0avg)
#np.savetxt('avg_change_0_P3.txt',changepavg)
#np.savetxt('avg_change_0_P3.txt',changenavg)
