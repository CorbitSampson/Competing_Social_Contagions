...
titlestring = 'sim_stability_sweep_bimodal_P2.txt'
np.savetxt(titlestring, sweepvar)
print('Simulation for bimodal has ended')
print('Max change after 3000 time steps is:')
#np.savetxt('max_change_0_P2_B.txt',change0max)
#np.savetxt('max_change_p_P2_B.txt',changepmax)
#np.savetxt('max_change_n_P2_B.txt',changenmax)
#np.savetxt('avg_change_0_P2_B.txt',change0avg)
#np.savetxt('avg_change_0_P2_B.txt',changepavg)
#np.savetxt('avg_change_0_P2_B.txt',changenavg)
